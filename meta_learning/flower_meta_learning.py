...
save_path = Path('/work/pi_hongyu_umass_edu/zonghai/mahbuba_medvidqa/semi_supervised/meta_learning/visualizations/meta_learning/flowers')

def main():
    # Create the dataset object
    original_dataset = OxfordFlowers(root=dataset_path, split='train', transform=None)
    ...
    def objective(**params):
        ...
        subset_size = 400  # Adjust the subset size
        ...
        _, _, _, _, val_accuracy = flower_train_model(model, subset1,subset2,val_loader, current_augmentation_policy, criterion,optimizer,save_path, num_epochs, device=device)
    ...
    with open('augmentation_policy_flower', 'w') as f:
